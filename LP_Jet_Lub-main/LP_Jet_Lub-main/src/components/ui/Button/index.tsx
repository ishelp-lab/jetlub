...
const ButtonNotification = ({ value }: { value: number }) => {
  ...
  return (
    <span className="absolute right-0 top-0 block h-6 w-8 -translate-y-1/2 translate-x-1/2 rounded-full bg-alert-400 text-sm/[1.5rem] group-disabled:bg-linkaGray-200">
      {formatValue}
    </span>
  );
};
