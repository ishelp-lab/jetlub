...
export const CTA = () => {
  ...
  const sendToWhatsApp = () => {
    const phoneNumber = "553430454595"
    
    const message = `*Solicitação de Orçamento - Jet Lub*
...
---
_Enviado através do site da Jet Lub_`
        ...
        <div className="bg-muted rounded-2xl shadow-xl p-12">
          ...
          {isSuccess && (
            <div className="mb-6 p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg">
              ...
              <p>Continue a conversa no WhatsApp para finalizar seu agendamento.</p>
            </div>
          )}
